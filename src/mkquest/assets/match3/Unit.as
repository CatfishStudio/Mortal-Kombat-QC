				...
				if (touch.phase == TouchPhase.BEGAN)
				{
					...
					{	
						...
						if (Match3.unit1 == null)
						{
							...
							Match3.CellColorEdit(Match3.unit1.posColumnI, Match3.unit1.posRowJ, Match3.unit1.unitType);
						}
						else 
						{
							if ((e.currentTarget as Unit) != Match3.unit1) 
							{
								...
								Match3.CellColorEdit(Match3.unit2.posColumnI, Match3.unit2.posRowJ, Match3.unit2.unitType);
