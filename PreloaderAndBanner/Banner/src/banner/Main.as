package banner
{
	...
	public class Main extends Sprite 
	{
		...
		private function loadPreloader():void
		{
			...
			//request = new URLRequest("https://app.vk.com/c420523/u99302165/c3fab2f4be2f6c.swf"); 
		...
		private function loadGame():void
		{
			loader = new Loader();
			loaderContext = new LoaderContext(false, ApplicationDomain.currentDomain, SecurityDomain.currentDomain);
			//request = new URLRequest("https://app.vk.com/c420925/u99302165/a2dd16a54b8b44.swf"); 
			request = new URLRequest("http://localhost:8080/Game.swf");
			loader.contentLoaderInfo.addEventListener(Event.COMPLETE, onComplete);
